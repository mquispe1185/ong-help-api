...
RSpec.describe "/ongs", type: :request do
  ...
  # OngsController, or in your router and rack
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Ong" do
        expect {
          post ongs_url,
               params: { ong: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new ong" do
        post ongs_url,
             params: { ong: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested ong" do
        ong = Ong.create! valid_attributes
        patch ong_url(ong),
              params: { ong: new_attributes }, headers: valid_headers, as: :json
        ong.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested ong" do
      ong = Ong.create! valid_attributes
      expect {
        delete ong_url(ong), headers: valid_headers, as: :json
      }.to change(Ong, :count).by(-1)
    end
  end
end
