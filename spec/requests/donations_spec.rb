...
RSpec.describe "/donations", type: :request do
  ...
  # DonationsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get donations_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Donation" do
        expect {
          post donations_url,
               params: { donation: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Donation" do
        expect {
          post donations_url,
               params: { donation: invalid_attributes }, as: :json
        }.to change(Donation, :count).by(0)
      end

      it "renders a JSON response with errors for the new donation" do
        post donations_url,
             params: { donation: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested donation" do
        ...
        patch donation_url(donation),
              params: { donation: new_attributes }, headers: valid_headers, as: :json
        donation.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested donation" do
      donation = Donation.create! valid_attributes
      expect {
        delete donation_url(donation), headers: valid_headers, as: :json
      }.to change(Donation, :count).by(-1)
    end
  end
end
